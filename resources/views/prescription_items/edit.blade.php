...
@section('title', 'Edit Prescription Item')

@section('page-subtitle', 'Edit Prescription Item')
...
<div>
    ...
    <div class="page-description">
        Update the prescribed medicine information.
    </div>
</div>

<a
    href="{{ route('prescription-items.show', $prescriptionItem->id) }}"
    class="btn-back"
>
    ← Back
</a>
...
<form
    action="{{ route('prescription-items.update', $prescriptionItem->id) }}"
    method="POST"
>
